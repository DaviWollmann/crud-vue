...
/*
OBSERVAÇÕES:
    FIZ USO DAS "ACTIONS" SOMENTE PARA FINGIR QUE SERIA UMA ROTINA COM BACKEND BUSCANDO OS DADOS DE UMA BASE,
    COMO ESTÁ SENDO TUDO GRAVADO NA MEMÓRIA, E NÃO TENHO QUE FAZER NENHUMA REQUISIÇÃO ASSINCRONA, SEI QUE NÃO
    PRECISARIA TER UTILIZADO.

    OUTRA COISA É QUE ESSA CLASSE FICOU UM MEGAZORD, PRIMEIRA VEZ USANDO VUE E VUEX,
    MAS JÁ ESTOU APRENDENDO SOBRE OS MODULOS NO VUEX, PRA PODER SEPARAR O PROGRAMA DIREITINHO.
*/
